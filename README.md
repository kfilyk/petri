...
4: When the "NETCHILDREN" graph has stabilized with a value above 1,  you can turn on regress/propagate functions (in the console menu) to accelerate their evolution. Note that these functions are experimental, and will direct them towards having the greatest number of children. Start low, with "REGRESS </1 CHILDREN" and "PROPOGATION ON". 
